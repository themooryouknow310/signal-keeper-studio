    ...
    <section id="founder" className="py-32 cinema-surface-with-grain relative">
      ...
      <div className="container mx-auto px-6 relative z-10">
        ...
        <AnimatedSection className="text-center mb-20">
          ...
          <h2 className="heading-display text-4xl md:text-5xl lg:text-6xl mb-6 glow-text font-bold">
            MEET YOUR GUIDE
          </h2>
        ...
        <div className="max-w-6xl mx-auto">
          <div className="grid md:grid-cols-2 gap-16 items-center">
            ...
            <AnimatedSection delay={400} className="space-y-8">
              <div>
                <h3 className="heading-display text-3xl md:text-4xl mb-4 cinema-text-shadow glow-text font-bold">

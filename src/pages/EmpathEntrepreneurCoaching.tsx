            ...
            <div className="relative z-10">
              ...
              <div className="ssos-grid grid-cols-1 md:grid-cols-2 max-w-6xl mx-auto">
                ...
                <div className="ssos-card">
                  <div className="mb-8">
                    <div className="flex items-center gap-4 mb-6">
                      <div className="w-14 h-14 rounded-full bg-gradient-to-br from-cyan/20 to-brass/20 flex items-center justify-center border-2 border-brass/40 shadow-lg">
                    ...
                    <div className="cinema-surface border border-signal/20 rounded-2xl p-8 bg-background/30 backdrop-blur-sm text-center">
                      <div className="mb-6">
                        <img 
                          src={marissaFontana} 
                          alt="Marissa Fontana" 
                          className="w-36 h-36 rounded-full object-cover mx-auto border-2 border-signal/30"
                        />
                        <img 

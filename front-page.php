...
<section class="min-h-screen flex items-center justify-center relative overflow-hidden py-20 surface-dark cinema-surface-with-grain" style="position: relative; overflow: hidden;">
    ...
    <div class="cinema-hero-bg" style="position:absolute; inset:0; background-image:url('<?php echo get_template_directory_uri(); ?>/assets/images/cinema/hero-spiritual-teacher.jpg'); background-size:cover; background-position:center; background-repeat:no-repeat; opacity:0.7; z-index:0;"></div>
    <div class="cinema-hero-overlay" style="position:absolute; inset:0; z-index:1; pointer-events:none;"></div>
